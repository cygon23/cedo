      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-white/90 mb-6 leading-relaxed">
              Community Empowerment and Development Organization (CEDO) works to address 
              health and nutrition challenges in Tanzania through education, advocacy, and community empowerment.
            </p>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  <p className="text-white/90">Dar es Salaam, Tanzania</p>
                  <p className="text-white/80 text-sm">Mwanza Regional Office</p>
                </div>
              </div>
              <div className="flex items-center">
                <Phone className="w-5 h-5 mr-3 text-white/80" />
                <p className="text-white/90">+255 XXX XXX XXX</p>
              </div>
              <div className="flex items-center">
                <Mail className="w-5 h-5 mr-3 text-white/80" />
                <p className="text-white/90">info@cedo.or.tz</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-white/20 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-white/80 text-sm mb-4 md:mb-0">
            © 2024 Community Empowerment and Development Organization (CEDO). All rights reserved.
          </p>
