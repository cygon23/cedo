      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Measurable change and lasting transformation in the communities we serve
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {stats.map((stat, index) => (
            <Card key={index} className="border-0 shadow-lg hover:shadow-xl transition-shadow duration-300 bg-gradient-to-br from-white to-primary/5">
        ...
        <div className="bg-gradient-to-r from-primary/5 to-secondary/5 rounded-2xl p-8 md:p-12">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold text-foreground mb-4">Key Achievements</h3>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Highlighting our most significant accomplishments in community empowerment and development
            </p>
          </div>
        ...
        <div className="mt-16 text-center">
          <h3 className="text-2xl font-bold text-foreground mb-4">Stories of Change</h3>
          <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
            Every number represents a life transformed, a community empowered, and hope restored. 
            Behind our statistics are real people whose lives have been positively impacted.
          </p>
          <div className="bg-gradient-to-r from-hope to-secondary text-white rounded-xl p-6 max-w-4xl mx-auto">
            <blockquote className="text-lg italic mb-4">
              "CEDO's health education program changed everything for our village. We now have better nutrition, 
              cleaner water, and most importantly, hope for our children's future."
            </blockquote>
            <cite className="text-sm font-semibold">- Maria, Community Leader, Mwanza Region</cite>
          </div>
        </div>
      </div>
    </section>
